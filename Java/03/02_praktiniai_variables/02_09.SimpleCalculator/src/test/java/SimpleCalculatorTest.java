...
public class SimpleCalculatorTest {
    ...
    private void correctOutput(String first, String second) {
        ...
        String[] lines = new String[] { "Give the first number:", "Give the second number:",
        ...
        assertEquals("Output was expected to be " + lines.length + " lines long" + ". Output was " + inputLines.size()
                + " lines long.", lines.length, inputLines.size());
    ...
    public void correctOrder() {
        ...
        int no = countOccurrences(sourceCode,
                "System.out.println.*Integer.*System.out.println.*Integer.*System.out.println");
        int no2 = countOccurrences(sourceCode,
