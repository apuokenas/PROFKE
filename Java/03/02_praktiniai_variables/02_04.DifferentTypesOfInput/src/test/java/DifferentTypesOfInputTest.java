...
public class DifferentTypesOfInputTest {
    ...
    private void correctOutput(String str, String integer, String dbl, String bool) {
        ...
        String[] lines = new String[] { "Give a string: ", "Give an integer: ", "Give a double: ", "Give a boolean: ",
                "You gave the string " + str, "You gave the integer " + Integer.valueOf(integer),
                "You gave the double " + Double.valueOf(dbl), "You gave the boolean " + Boolean.valueOf(bool) };

        List<String> output = rivit(io.getSysOut().trim());

        assertEquals("Program output should be " + lines.length + " lines long" + ". Now it was " + output.size() + ".",
                lines.length, output.size());
    ...
    public void correctOrder() {
        ...
        int no = countOccurrences(solutionCode,
                "System.out.println.*String.*System.out.println.*Integer.*System.out.println.*Double.*System.out.println.*Boolean.*System.out.println");
        int no2 = countOccurrences(solutionCode,
                "System.out.println.*String.*System.out.println.*nextInt.*System.out.println.*nextDouble.*System.out.println.*nextBoolean.*System.out.println");
        assertTrue(
