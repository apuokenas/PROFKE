...
public class CheckingTheAgeTest {
    ...
    private void checkOkAge(int age) {
        ...
        assertTrue("When the input is " + age + " program output should contain \"OK\", program output was " + out,
                out.toLowerCase().contains("ok"));
        assertTrue("When the input is  " + age + " program output should not contain \"OK\", program output was " + out,
                !out.toLowerCase().contains("imp"));
    }
    ...
    private void checkImpossibleAge(int age) {
        ...
        assertTrue("The program had no output!", out.length() > 0);
        assertTrue("When the input is  " + age + " program output should contain \"Impossible\", program output was "
                + out, out.toLowerCase().contains("imp"));
        assertTrue("When the input is " + age + " program output should not contain \"OK\", Program output was " + out,
                !out.toLowerCase().contains("ok"));
    }
