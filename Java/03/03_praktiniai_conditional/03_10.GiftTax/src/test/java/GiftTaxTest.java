...
public class GiftTaxTest {
    ...
    private void calculatesRightTax(int valueOfGift, double tax) {
        ...
        if (tax < 0) {
            assertTrue("With input " + valueOfGift + " output was \"" + out + "\". Expected \"No tax!\"",
                    out.toLowerCase().contains("no"));
        } else {
            assertFalse("With input " + valueOfGift + " output was \"" + out + "\". Did not expext  \"No Tax\".",
                    out.toLowerCase().contains("no"));
            assertTrue("With input " + valueOfGift + " output was \"" + out + "\". Expected the tax to be" + tax,
                    out.toLowerCase().contains("" + tax));
        }
    }
